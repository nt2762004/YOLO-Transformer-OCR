...
def get_sample_images(dataset_type: str = "vn", split: str = "train", limit: int = 9):
...
def main():
    ...
    with st.spinner("Loading models..."):
        detector, recognizer, tokenizer = load_models(device=device)
    ...
    if st.session_state.active_tab == 0:
            ...
            samples = get_sample_images(dataset_type=dataset_type, split=split, limit=st.session_state.samples_count)
            ...
            if not samples:
                ...
                all_samples = get_sample_images(dataset_type=dataset_type, split=split, limit=999)
